      ...
      <div className='product_page'>
        ...
        <div className='image-gallery'>
          <div className='row'>
            ...
            {birthdayCakes.filter(cake => cake.name.toLowerCase().includes(this.state.searchField.toLowerCase())).map(item => {
              return (
                <ProductPageCard key={item.id} item={item} />
              );
            })}
          </div>
          ...
          <div className='cupcakes'>
            <div className='row'>
              <h2>Cup Cakes</h2>
              {cupCakes.filter(cake => cake.name.toLowerCase().includes(this.state.searchField.toLowerCase())).map(item => {
              return (
                <ProductPageCard key={item.id} item={item} />
                );
              })}
          ...
          <div className='cupcakes'>
            <div className='row'>
              <h2>Wedding Cakes</h2>
              {weddingCakes.filter(cake => cake.name.toLowerCase().includes(this.state.searchField.toLowerCase())).map(item => {
              return (
                <ProductPageCard key={item.id} item={item} />
                );
              })}
            ...
            <div className='cupcakes'>
              <div className='row'>
                <h2>Other cakes</h2>
                {others.filter(cake => cake.name.toLowerCase().includes(this.state.searchField.toLowerCase())).map(item => {
              return (
                <ProductPageCard key={item.id} item={item} />
                  );
                })}
